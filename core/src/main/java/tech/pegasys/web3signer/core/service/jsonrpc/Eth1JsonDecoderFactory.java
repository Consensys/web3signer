...
public class Eth1JsonDecoderFactory {
  private final JsonDecoder jsonDecoder;

  private static final Eth1JsonDecoderFactory FACTORY = new Eth1JsonDecoderFactory();

  private Eth1JsonDecoderFactory() {
