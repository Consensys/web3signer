 ...
 */
package tech.pegasys.web3signer.core.signing.filecoin;

import static org.apache.tuweni.bytes.Bytes.concatenate;
import static tech.pegasys.web3signer.core.signing.filecoin.FilecoinProtocol.BLS;
import static tech.pegasys.web3signer.core.signing.filecoin.FilecoinProtocol.ID;
import static tech.pegasys.web3signer.core.signing.filecoin.FilecoinProtocol.SECP256K1;
import static tech.pegasys.web3signer.core.util.ByteUtils.fromUVariant;
import static tech.pegasys.web3signer.core.util.ByteUtils.putUVariant;

import tech.pegasys.web3signer.core.signing.filecoin.exceptions.InvalidAddressChecksumException;
import tech.pegasys.web3signer.core.signing.filecoin.exceptions.InvalidAddressLengthException;
import tech.pegasys.web3signer.core.signing.filecoin.exceptions.InvalidAddressPayloadException;
