...
public class BlindedBlockBellatrix extends BeaconBlockAltair {
  ...
  public BlindedBlockBellatrix(final BeaconBlock message) {
    super(
        message.getSlot(),
        message.getProposerIndex(),
        message.getParentRoot(),
        message.getStateRoot(),
        new BlindedBeaconBlockBodyBellatrix(
            message.getBody().toBlindedVersionBellatrix().orElseThrow()));
  }
  ...
  @JsonProperty("body")
  @Override
  public BlindedBeaconBlockBodyBellatrix getBody() {
    return (BlindedBeaconBlockBodyBellatrix) body;
  }

  @JsonCreator
  public BlindedBlockBellatrix(
      ...
      @JsonProperty("body") final BlindedBeaconBlockBodyBellatrix body) {
