...
import tech.pegasys.web3signer.core.service.http.handlers.signing.eth2.schema.capella.HistoricalSummary;
...
public class BeaconStateDeneb extends BeaconStateAltair {
  ...
  public BeaconStateDeneb(final BeaconState beaconState) {
    ...
    this.historicalSummaries =
        deneb.getHistoricalSummaries().stream().map(HistoricalSummary::new).toList();
  }
