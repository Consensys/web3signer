...
public class SignedBlindedBeaconBlockElectra extends SignedBeaconBlock implements SignedBlock {
  private final BlindedBlockElectra message;

  public SignedBlindedBeaconBlockElectra(
    ...
    this.message = new BlindedBlockElectra(internalBlock.getMessage());
  }

  @Override
  public BlindedBlockElectra getMessage() {
    return message;
  }

  @JsonCreator
  public SignedBlindedBeaconBlockElectra(
      @JsonProperty("message") final BlindedBlockElectra message,
