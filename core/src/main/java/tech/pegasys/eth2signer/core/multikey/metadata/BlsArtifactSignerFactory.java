...
public class BlsArtifactSignerFactory implements ArtifactSignerFactory<BLSSignature> {
  ...
  @Override
  public ArtifactSigner<BLSSignature> create(final FileRawSigningMetadata fileRawSigningMetadata) {
  ...
  @Override
  public ArtifactSigner<BLSSignature> create(final FileKeyStoreMetadata fileKeyStoreMetadata) {
  ...
  @Override
  public ArtifactSigner<BLSSignature> create(final HashicorpSigningMetadata hashicorpMetadata) {
  ...
  private ArtifactSigner<BLSSignature> createKeystoreArtifact(
  ...
  private ArtifactSigner<BLSSignature> createHashicorpArtifact(
