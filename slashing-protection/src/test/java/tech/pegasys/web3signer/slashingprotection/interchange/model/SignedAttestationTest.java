...
class SignedAttestationTest {
  ...
  void fieldNamesAlignWithSpec() throws JsonProcessingException {
    ...
    final Map<String, String> jsonContent = Json.decodeValue(jsonOutput, Map.class);
    ...
    assertThat(jsonContent.get("signing_root")).isEqualTo(attestation.getSigningRoot().toHexString());
  }
