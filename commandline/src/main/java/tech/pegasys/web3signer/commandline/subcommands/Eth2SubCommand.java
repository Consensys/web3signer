...
import tech.pegasys.web3signer.commandline.PicoCliSecretsMangerAwsParameters;
...
public class Eth2SubCommand extends ModeSubCommand {
  ...
  @Mixin private PicoCliSecretsMangerAwsParameters awsSecretsManagerParameters;
  ...
  @VisibleForTesting
  public PicoCliSecretsMangerAwsParameters getAwsSecretsManagerParameters() {
